...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "cn_030-recreation".to_string(),
        eval_scale: 400.0,
        steps: TrainingSteps {
            batch_size: 16_384,
        ...
        lr_scheduler: lr::Warmup { inner: lr_schedule, warmup_batches: lr_warmup },
        save_rate: 10,
    };
    ...
    //trainer.load_from_checkpoint("D:/bullet/checkpoints/cn_031-3step-600");
